...
# ==================== SOZLAMALAR ====================
TELEGRAM_TOKEN = "8847118582:AAEUFRqi81_4ztx1UUPODmtAyJuOCL7jDNU"
GEMINI_API_KEY = "8847118582:AAEUFRqi81_4ztx1UUPODmtAyJuOCL7jDNU"
...
def normalize_gender(gender_text: str) -> str:
    ...
    male_markers = ["o'g'il", "og'il", "erkek", "남자", "男の子", "boy", "male"]
